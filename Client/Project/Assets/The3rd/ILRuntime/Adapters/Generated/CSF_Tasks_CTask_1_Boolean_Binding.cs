...
{
    unsafe class CSF_Tasks_CTask_1_Boolean_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(CSF.Tasks.CTask<System.Boolean>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            CSF.Tasks.CTask<System.Boolean> instance_of_this_method = (CSF.Tasks.CTask<System.Boolean>)typeof(CSF.Tasks.CTask<System.Boolean>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
