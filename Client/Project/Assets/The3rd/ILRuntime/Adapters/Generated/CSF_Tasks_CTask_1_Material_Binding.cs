...
{
    unsafe class CSF_Tasks_CTask_1_Material_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(CSF.Tasks.CTask<UnityEngine.Material>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            CSF.Tasks.CTask<UnityEngine.Material> instance_of_this_method = (CSF.Tasks.CTask<UnityEngine.Material>)typeof(CSF.Tasks.CTask<UnityEngine.Material>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
