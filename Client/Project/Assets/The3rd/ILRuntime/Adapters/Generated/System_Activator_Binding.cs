...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Activator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(CSF.IDisposableClassInheritanceAdaptor.IDisposableAdaptor)};
            if (genericMethods.TryGetValue("CreateInstance", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(CSF.IDisposableClassInheritanceAdaptor.IDisposableAdaptor)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* CreateInstance_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Activator.CreateInstance<CSF.IDisposableClassInheritanceAdaptor.IDisposableAdaptor>();
