...
public class Reporter : MonoBehaviour
{
	...
	public class Sample
	{
		...
		public string GetSceneName()
		{
            ...
            if (scenes == null || loadedScene >=scenes.Length)
                return "Unknow Scene";
	...
	public void Initialize()
	{
        ...
        msgContent = new GUIContent("", images.logImage, "Msg logs");
        ...
        msglog = (PlayerPrefs.GetInt("Reporter_msglog") == 1) ? true : false;
	...
	void drawToolBar()
	{
        ...
        if (GUILayout.Button(msgContent, (msglog) ? buttonActiveStyle : barStyle, GUILayout.Width(size.x * 2), GUILayout.Height(size.y * 2)))
        {
            msglog = !msglog;
            setIsShowLog();
        }
	...
	void OnApplicationQuit()
	{
        ...
        PlayerPrefs.SetInt("Reporter_msglog", (msglog == true) ? 1 : 0);
